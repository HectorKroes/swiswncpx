...
LUSC_SWIGN_GAS6_plot <- ggplot(LUSC_FPKM, aes(x=log2(SWINGN), y=log2(GAS6))) + geom_point() + theme_grey(base_size = 10) 
LUSC_SWIGN_GAS6_plot <- LUSC_SWIGN_GAS6_plot + stat_cor(method="pearson", p.accuracy=1e-100, label.sep='\n')

LUSC_SWIGN_PDGFRB_plot <- ggplot(LUSC_FPKM, aes(x=log2(SWINGN), y=log2(PDGFRB))) + geom_point() + theme_grey(base_size = 10)
LUSC_SWIGN_PDGFRB_plot <- LUSC_SWIGN_PDGFRB_plot + stat_cor(method="pearson", p.accuracy=1e-100, label.sep='\n')

LUSC_SWIGN_COL1A1_plot <- ggplot(LUSC_FPKM, aes(x=log2(SWINGN), y=log2(COL1A1))) + geom_point() + theme_grey(base_size = 10)
LUSC_SWIGN_COL1A1_plot <- LUSC_SWIGN_COL1A1_plot + stat_cor(method="pearson", p.accuracy=1e-100, label.sep='\n')

LUSC_plots <- ggarrange(LUSC_SWIGN_GAS6_plot, LUSC_SWIGN_PDGFRB_plot, LUSC_SWIGN_COL1A1_plot)
ggsave('LUSC.png', LUSC_plots)
LUSC_plots

BRCA_SWIGN_GAS6_plot <- ggplot(BRCA_FPKM, aes(x=log2(SWINGN), y=log2(GAS6))) + geom_point() + theme_grey(base_size = 10) 
BRCA_SWIGN_GAS6_plot <- BRCA_SWIGN_GAS6_plot + stat_cor(method="pearson", p.accuracy=1e-100, label.sep='\n')

LUAD_SWIGN_GAS6_plot <- ggplot(LUAD_FPKM, aes(x=log2(SWINGN), y=log2(GAS6))) + geom_point() + theme_grey(base_size = 10) 
LUAD_SWIGN_GAS6_plot <- LUAD_SWIGN_GAS6_plot + stat_cor(method="pearson", p.accuracy=1e-100, label.sep='\n')

PRAD_SWIGN_GAS6_plot <- ggplot(PRAD_FPKM, aes(x=log2(SWINGN), y=log2(GAS6))) + geom_point() + theme_grey(base_size = 10) 
PRAD_SWIGN_GAS6_plot <- PRAD_SWIGN_GAS6_plot + stat_cor(method="pearson", p.accuracy=1e-100, label.sep='\n')

COAD_SWIGN_GAS6_plot <- ggplot(COAD_FPKM, aes(x=log2(SWINGN), y=log2(GAS6))) + geom_point() + theme_grey(base_size = 10) 
COAD_SWIGN_GAS6_plot <- COAD_SWIGN_GAS6_plot + stat_cor(method="pearson", p.accuracy=1e-100, label.sep='\n')

GAS6_plots <- ggarrange(BRCA_SWIGN_GAS6_plot, LUAD_SWIGN_GAS6_plot, PRAD_SWIGN_GAS6_plot, COAD_SWIGN_GAS6_plot)
